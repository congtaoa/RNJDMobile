...
export default class HomeSecondThreeView extends Component{
        ...
        return (
            <View style={[{width:commonWidth},this.props.borderStyles,styles.container]}>
                ...
                <View style={styles.rowImage}>
                    <Image source={{ uri:item.image }} style={{ width: 50, height:65 }} />
                    <Image source={{ uri:item.secondImage }} style={{ width: 50, height: 65 }} />
                    <Image source={{ uri:item.thirdImage }} style={{ width: 50, height: 65 }} />
                </View>
                {
                    item.special != ''
                        ?
